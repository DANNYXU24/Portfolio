      ...
      <main className="flex flex-col gap-4 items-start w-full">
        ...
        <div className="portfolio w-full">
          ...
          <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full">
            {/* Project 7 card - with hover overlay and title */}
            <Link href="/projects/project7/" className="block w-full">
              <li className="aspect-square border-3 border-transparent hover:border-[#FFFDD0] shadow hover:shadow-lg transition-all duration-300 cursor-pointer relative overflow-hidden">
                ...
                >
                  <h3 className="text-xl font-semibold text-white">Adaptive Preference Interface</h3>
                </div>
              </li>
            </Link>
            {/* Project 6 card - with hover overlay and title */}
            <Link href="/projects/project6/" className="block w-full">
              <li className="aspect-square border-3 border-transparent hover:border-[#FFFDD0] shadow hover:shadow-lg transition-all duration-300 cursor-pointer relative overflow-hidden">
                ...
                >
                  <h3 className="text-xl font-semibold text-white">Cogs 187B</h3>
                </div>
              </li>
            </Link>
            {/* Project 5 card - with hover overlay and title */}
            <Link href="/projects/project5/" className="block w-full">
              <li className="aspect-square border-3 border-transparent hover:border-[#FFFDD0] shadow hover:shadow-lg transition-all duration-300 cursor-pointer relative overflow-hidden">
                ...
                >
                  <h3 className="text-xl font-semibold text-white">Heart Rate Research</h3>
                </div>
              </li>
            </Link>
            {/* Project 4 card - with hover overlay and title */}
            <Link href="/projects/project4/" className="block w-full">
              <li className="aspect-square border-3 border-transparent hover:border-[#FFFDD0] shadow hover:shadow-lg transition-all duration-300 cursor-pointer relative overflow-hidden">
                ...
                >
                  <h3 className="text-xl font-semibold text-white">Gaussian Splat Exploration</h3>
                </div>
              </li>
            </Link>
            ...
            <Link href="/projects/project3/" className="block w-full">
              <li className="aspect-square border-3 border-transparent hover:border-[#FFFDD0] shadow hover:shadow-lg transition-all duration-300 cursor-pointer relative overflow-hidden">
                ...
                >
                  <h3 className="text-xl font-semibold text-white">Cogs127</h3>
                </div>
              </li>
            </Link>
